...
Aktuelle Projekte beinhalten oft eine \href{https://editorconfig.org/}{.editorconfig}-Datei aus, die von den meisten aktuellen IDEs berücksichtigt wird. Für unseren älteren Projekte musst Du wahrscheinlich eine Formatierungsdaten im XML-Format (meist Eclipse) importieren.
